    ...
    <section className="container py-16">
      <div className="text-center mb-10">
        <Badge variant="outline" className="border-primary/40 text-primary mb-4">
          <Trophy className="h-3 w-3 mr-1" /> Mastery Dashboard
        </Badge>
        <h2 className="font-display text-4xl md:text-5xl font-bold mb-3">Civic <span className="gold-text">Mastery Hub</span></h2>
      ...
      <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto mb-8">
        <div className="impact-card precision-border p-6 text-center">
        ...
        <div className="impact-card p-6 text-center">
      ...
      <div className="grid md:grid-cols-2 gap-4 max-w-5xl mx-auto mb-8">
        ...
        <div className="impact-card p-6">
          ...
          <p className="text-sm text-muted-foreground mb-3">Wipe progress and start the civic journey anew.</p>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {[...earned, ...locked].map((b) => {
            ...
            return (
              <div key={b.id} className={`impact-card p-4 flex gap-3 items-start ${!owned ? "opacity-40" : "precision-border"}`}>
